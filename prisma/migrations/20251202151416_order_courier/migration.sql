...
INSERT INTO "new_Order" ("completedAt", "description", "id", "orderedAt", "receiverLat", "receiverLng", "senderLat", "senderLng", "size", "volume", "weight") SELECT "completedAt", "description", "id", "orderedAt", "receiverLat", "receiverLng", "senderLat", "senderLng", "size", "volume", "weight" FROM "Order";
DROP TABLE "Order";
